# -*- coding: utf-8 -*-
"""
Created on Wed Oct 28 20:24:54 2020
...
frequent_itemsets1 = apriori(movie, min_support=0.005, max_len=3,use_colnames = True)
frequent_itemsets1.sort_values('support',ascending = False,inplace=True)
plt.bar(x = list(range(1,5)),height = frequent_itemsets1.support[1:5],color='rgmyk');plt.xticks(list(range(1,5)),frequent_itemsets1.itemsets[1:5])
...
frequent_itemsets2 = apriori(movie, min_support=0.01, max_len=2,use_colnames = True)
